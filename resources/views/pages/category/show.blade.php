...
@section('content')
    <div id="TopNav" class="relative flex items-center justify-between px-5 mt-[60px]">
        <a href="index.html"
            ...
            <img src="{{ asset('assets/images/icons/arrrow-left.svg') }}" class="w-[28px] h-[28px]" alt="icon">
        </a>
            ...
            <a href="details.html" class="card">
                <div
                    ...
                    <div class="flex flex-col gap-3 w-full">
                        <h3 class="font-semibold text-lg leading-[27px] line-clamp-2 min-h-[54px]">hhashah</h3>
